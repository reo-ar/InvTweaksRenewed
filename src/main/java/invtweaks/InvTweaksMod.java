...
public class InvTweaksMod {
  ...
  public static @Nullable Slot getDefaultButtonPlacement(
  ...
  public void keyInput(GuiScreenEvent.KeyboardKeyPressedEvent.Pre event) {
    ...
    final ContainerScreen<?> container = (ContainerScreen<?>) gui;
    ...
    if (slot != null && slot.inventory != null) {
      if (container.getContainer().inventorySlots != null
          && container.getContainer().inventorySlots.contains(slot)) {
  ...
  public void mouseInput(GuiScreenEvent.MouseClickedEvent.Pre event) {
    final Screen gui = event.getGui();
    if (!(gui instanceof ContainerScreen && !(event.getGui() instanceof CreativeScreen))) {
      return;
    }
    final ContainerScreen<?> container = (ContainerScreen<?>) gui;
