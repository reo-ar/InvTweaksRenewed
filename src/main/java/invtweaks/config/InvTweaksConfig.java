...
public class InvTweaksConfig {
    ...
    public static final Map<String, ContOverride> DEFAULT_CONT_OVERRIDES
            ...
            "mcjty.rftoolsutility.modules.crafter.blocks.CrafterContainer", new ContOverride(NO_POS_OVERRIDE, NO_POS_OVERRIDE, ""));
    ...
    public static Map<String, Category> cfgToCompiledCats(List<UnmodifiableConfig> lst) {
        ...
        for (UnmodifiableConfig subCfg : lst) {
            ...
            if (!name.equals("") && !name.startsWith("/")) {
                catsMap.put(name,
                        new InvTweaksConfig.Category(subCfg.getOrElse("spec", Collections.emptyList())
                        ));
            }
        }
        return catsMap;
